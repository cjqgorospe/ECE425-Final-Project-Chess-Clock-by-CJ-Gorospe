...
void EduBase_LCD_Ports_Init(void)
{
	...
	//Enable the digital functionality for PA6 pin
	...
	// Initiazlie the output of the PE0 pin to zero
...
void EduBase_LCD_Write_4_Bits(uint8_t data, uint8_t control_flag)
{
	...
	// Set or clear the register select (RS) pin based on the control flah
