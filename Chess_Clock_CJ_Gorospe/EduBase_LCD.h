...
/**
 * @brief Displays a heart character on the LCD.
 *
 * This function displays a custom heart character previously stored in the LCD's 
 * CGRAM using the EduBase_LCD_Create_Custom_Character function.
 *
 *
 * @param None
 *
